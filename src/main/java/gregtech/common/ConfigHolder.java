...
public class ConfigHolder {
    ...
    public static class RecipeOptions {
        ...
        @Config.Comment({ "Whether to remove Block/Ingot compression and decompression in the Crafting Table for GTCEu and Vanilla materials.",
                "Default: false" })
        public boolean disableManualCompression = false;

        @Config.Comment({ "Whether to remove Block/Ingot compression and decompression in the Crafting Table for non-GTCEu materials.",
                "Default: false" })
