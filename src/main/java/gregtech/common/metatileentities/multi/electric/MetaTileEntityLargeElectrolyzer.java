...
public class MetaTileEntityLargeElectrolyzer extends GCYMRecipeMapMultiblockController {
    ...
    protected @NotNull BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start()
                ...
                .where('C', states(getCellState()))
                .where('T', tieredCasing().or(states(getCellState())))
                .build();
    }
    ...
    private static IBlockState getCellState() {
        return GCYMMetaBlocks.UNIQUE_CASING
                .getState(BlockUniqueCasing.UniqueCasingType.ELECTROLYTIC_CELL);
    }
