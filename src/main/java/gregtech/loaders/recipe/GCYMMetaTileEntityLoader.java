...
public final class GCYMMetaTileEntityLoader {
    ...
    public static void init() {
        ModHandler.addShapedRecipe(true, "large_macerator",
                GCYMMetaTileEntities.LARGE_MACERATOR.getStackForm(),
                "TCT", "PSP", "MWM",
        ...
        ModHandler.addShapedRecipe(true, "alloy_blast_smelter",
                GCYMMetaTileEntities.ALLOY_BLAST_SMELTER.getStackForm(),
                "TCT", "WSW", "TCT",
        ...
        ModHandler.addShapedRecipe(true, "large_arc_furnace",
                GCYMMetaTileEntities.LARGE_ARC_FURNACE.getStackForm(),
                "WGW", "CSC", "TTT",
                'T', new UnificationEntry(plate, TantalumCarbide),
                'C', new UnificationEntry(circuit, MarkerMaterials.Tier.IV),
        ...
        ModHandler.addShapedRecipe(true, "large_assembler",
                GCYMMetaTileEntities.LARGE_ASSEMBLER.getStackForm(),
                "RWR", "CSC", "PWP",
        ...
        ModHandler.addShapedRecipe(true, "large_autoclave",
                GCYMMetaTileEntities.LARGE_AUTOCLAVE.getStackForm(),
                "ACA", "ASA", "PWP",
        ...
        ModHandler.addShapedRecipe(true, "large_bender",
                GCYMMetaTileEntities.LARGE_BENDER.getStackForm(),
                "PWP", "BCS", "FWH",
                'C', new UnificationEntry(circuit, MarkerMaterials.Tier.IV),
                'P', MetaItems.ELECTRIC_PISTON_IV.getStackForm(),
        ...
        ModHandler.addShapedRecipe(true, "large_brewer",
                GCYMMetaTileEntities.LARGE_BREWERY.getStackForm(),
                "SCS", "BFH", "PWP",
        ...
        ModHandler.addShapedRecipe(true, "large_centrifuge",
                GCYMMetaTileEntities.LARGE_CENTRIFUGE.getStackForm(),
                "HPH", "RCT", "MWM",
                'C', new UnificationEntry(circuit, MarkerMaterials.Tier.IV),
        ...
        ModHandler.addShapedRecipe(true, "large_chemical_bath",
                GCYMMetaTileEntities.LARGE_CHEMICAL_BATH.getStackForm(),
                "PGP", "BCO", "MWM",
                'C', new UnificationEntry(circuit, MarkerMaterials.Tier.IV),
        ...
        ModHandler.addShapedRecipe(true, "large_extractor",
                GCYMMetaTileEntities.LARGE_EXTRACTOR.getStackForm(),
                "PGP", "BCO", "MWM",
                'C', new UnificationEntry(circuit, MarkerMaterials.Tier.IV),
        ...
        ModHandler.addShapedRecipe(true, "large_cutter",
                GCYMMetaTileEntities.LARGE_CUTTER.getStackForm(),
                "SPS", "BCO", "MWM",
                'C', new UnificationEntry(circuit, MarkerMaterials.Tier.IV),
        ...
        ModHandler.addShapedRecipe(true, "large_distillery",
                GCYMMetaTileEntities.LARGE_DISTILLERY.getStackForm(),
                "LCL", "PSP", "LCL",
        ...
        ModHandler.addShapedRecipe(true, "large_electrolyzer",
                GCYMMetaTileEntities.LARGE_ELECTROLYZER.getStackForm(),
                "PCP", "LSL", "PWP",
        ...
        ModHandler.addShapedRecipe(true, "large_polarizer",
                GCYMMetaTileEntities.LARGE_POLARIZER.getStackForm(),
                "PSP", "BCO", "WSW",
                'C', new UnificationEntry(circuit, MarkerMaterials.Tier.IV),
        ...
        ModHandler.addShapedRecipe(true, "large_extruder",
                GCYMMetaTileEntities.LARGE_EXTRUDER.getStackForm(),
                "LCL", "PSP", "OWO",
        ...
        ModHandler.addShapedRecipe(true, "large_solidifier",
                GCYMMetaTileEntities.LARGE_SOLIDIFIER.getStackForm(),
                "LCL", "PSP", "LWL",
        ...
        ModHandler.addShapedRecipe(true, "large_mixer",
                GCYMMetaTileEntities.LARGE_MIXER.getStackForm(),
                "LCL", "RSR", "MWM",
        ...
        ModHandler.addShapedRecipe(true, "large_packager",
                GCYMMetaTileEntities.LARGE_PACKAGER.getStackForm(),
                "RCR", "PSP", "MPM",
        ...
        ModHandler.addShapedRecipe(true, "large_engraver",
                GCYMMetaTileEntities.LARGE_ENGRAVER.getStackForm(),
                "ECE", "PSP", "DWD",
                'C', new UnificationEntry(circuit, MarkerMaterials.Tier.IV),
        ...
        ModHandler.addShapedRecipe(true, "large_sifter",
                GCYMMetaTileEntities.LARGE_SIFTER.getStackForm(),
                "ACA", "PSP", "AWA",
                'C', new UnificationEntry(circuit, MarkerMaterials.Tier.IV),
        ...
        ModHandler.addShapedRecipe(true, "large_wiremill",
                GCYMMetaTileEntities.LARGE_WIREMILL.getStackForm(),
                "ACA", "RSR", "MWM",
                'C', new UnificationEntry(circuit, MarkerMaterials.Tier.IV),
        ...
        ModHandler.addShapedRecipe(true, "parallel_hatch_iv",
                GCYMMetaTileEntities.PARALLEL_HATCH[0].getStackForm(),
                "SCE", "CHC", "WCW",
        ...
        MetaTileEntityLoader.registerMachineRecipe(
                ArrayUtils.subarray(GCYMMetaTileEntities.TIERED_HATCH, 0, GregTechAPI.isHighTier() ? UHV : UV),
                "PPP", "PCP", "PPP",
                'P', PLATE, 'C', BETTER_CIRCUIT);
        ...
        if (!GregTechAPI.isHighTier()) {
            ModHandler.addShapedRecipe(true, "gcym.machine.tiered_hatch.uhv",
                    ...
                    "PPP", "PCP", "PPP",
                    'P', PLATE.getIngredient(UHV),
                    'C', CIRCUIT.getIngredient(UHV));
        }
    }
}
