...
public class AlloyBlastRecipeProducer {
    ...
    protected @NotNull BlastRecipeBuilder createBuilder(@NotNull BlastProperty property,
     ...
     */
    protected int addInputs(@NotNull Material material,
    ...
    protected void buildRecipes(@NotNull BlastProperty property, @NotNull Fluid molten, int outputAmount,
        ...
        if (property.getGasTier() != null) {
            ...
            FluidStack gas = CraftingComponents.EBF_GASES.get(property.getGasTier());
            if (gas != null) {
    ...
    protected void addFreezerRecipes(@NotNull Material material, @NotNull Fluid molten,
        ...
        int vacuumEUt = property.getVacuumEUtOverride() == -1 ? GTValues.VA[GTValues.MV] :
                property.getVacuumEUtOverride();
